...
Welcome to Rebels Animated Nodes, a complete aesthetic overhaul for your ComfyUI workspace.
...
Crash-Proof Architecture: Aggressive defensive loading ensures that if you are missing a specific third-party dependency (like the GGUF node pack), your server will never crash on boot.
...
CRITICAL STEP: Once ComfyUI loads in your browser, perform a Hard Refresh (Ctrl + F5 on Windows or Cmd + Shift + R on Mac). If you do not do this, your browser will cache old JavaScript and the animations will not load!
...
🖥️ Monitors
Rebel Matrix Monitor: Drop this anywhere in your workflow. It intercepts ComfyUI execution events, showing you exactly which node is running, displaying KSampler progress bars, and tracking cached node usage in real-time.
...
Created for the ComfyUI community by Rebel AI.
